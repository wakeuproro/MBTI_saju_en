...
{{
  ...
  "career": {{
    "title": "직업운 분석 제목 (예: 당신의 천직은 OO입니다)",
    "desc": "사주 오행과 MBTI 기반 직업 적성 심층 분석 (3~5문장)",
    "work_style": "업무 스타일 한 줄 요약 (예: 꼼꼼한 완벽주의, 빠른 판단력의 리더형 등)",
    "best_fields": ["추천 직업/분야 1", "추천 직업/분야 2", "추천 직업/분야 3", "추천 직업/분야 4", "추천 직업/분야 5"]
  }},
  "wealth": {{
    "title": "재물운 분석 제목 (예: 돈이 모이는 패턴이 있습니다)",
    "desc": "재성(편재/정재)의 위치와 상태에 따른 재물 흐름 심층 분석 (3~5문장)",
    "money_style": "금전 스타일 한 줄 요약 (예: 큰돈을 한번에 벌어들이는 투자형, 꾸준히 저축하는 안정형 등)",
    "wealth_tip": "재물운을 높이는 실천 가능한 구체적 팁 한 줄"
  }},
  "health": {{
    "title": "건강운 분석 제목 (예: 당신이 조심해야 할 건강 포인트)",
    "desc": "오행 균형 기반 건강 경향 심층 분석 (3~5문장)",
    "health_tip": "건강을 지키기 위한 구체적 생활 습관 팁 한 줄",
    "weak_points": ["주의 장기/부위 1", "주의 장기/부위 2", "주의 장기/부위 3"]
  }},
  "deep_wealth": {{
